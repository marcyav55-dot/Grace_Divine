...
export const SLIDES = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1760873059715-7c7cfbe2a2c6?w=900&q=80",
  },
  {
    title: "INFORMATIQUE",
...
export const SERVICES = [
  ...
  },
  {
    ...
    cta: "EN SAVOIR PLUS",
    img: "https://images.unsplash.com/photo-1760873059715-7c7cfbe2a2c6?w=600&q=75",
  },
  {
    id: 3,
    icon: "🔧",
...
export const SERVICES_PREMIUM = [
  {
    id: 1,
    icon: "💧",
    title: "Forage d'Eau Professionnel",
    slug: "forage",
    desc: "Forage de puits, installation de pompes et maintenance hydraulique pour familles, écoles et entreprises.",
    cta: "Découvrir",
    link: "/services/forage",
  ...
  },
  {
    ...
    slug: "electricite",
    desc: "Installation, mise aux normes et maintenance de systèmes électriques résidentiels et professionnels.",
    cta: "Découvrir",
    link: "/contact",
    img: "https://images.unsplash.com/photo-1566417110090-6b15a06ec800?w=800&q=80",
  },
  {
    id: 3,
    icon: "📡",
    title: "Réseaux & Télécommunications",
    slug: "reseaux",
    desc: "Câblage, WiFi, Starlink et configuration de réseaux fiables pour la maison ou l'entreprise.",
    cta: "Découvrir",
    link: "/services",
  ...
  },
  {
    ...
    slug: "informatique",
    desc: "Maintenance, réparation, vente de matériel et développement de logiciels sur mesure.",
    cta: "Découvrir",
    link: "/services",
  ...
  },
  {
    ...
    slug: "domotique",
    desc: "Automatisez votre maison ou bureau : éclairage, sécurité et contrôle à distance.",
    cta: "Découvrir",
    link: "/contact",
    img: "https://images.unsplash.com/photo-1774876549389-e82a7bea84a3?w=800&q=80",
  },
  {
    id: 6,
    icon: "🛒",
    title: "Boutique",
    slug: "boutique",
    desc: "Informatique, habillement et accessoires de qualité, à prix compétitifs.",
    cta: "Voir la boutique",
    link: "/boutique",
