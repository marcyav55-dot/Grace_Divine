  ...
  return (
    <div className="pv-overlay" onClick={onClose}>
      <style>{`
        ...
        .pv-dot.active { background: #f59e0b; width: 20px; border-radius: 4px; }
        .pv-sheet {
          background: #fff;
      ...
      {/* ─── Fiche caractéristiques (remonte du bas, comme Alibaba) ──────── */}
      <div className="pv-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 14 }}>
          <span style={{ fontSize: 26, fontWeight: 900, color: "#1d4ed8" }}>{priceUSD} $</span>
          {oldPriceUSD && (
        ...
        <div style={{ display: "flex", gap: 16, marginBottom: 20, fontSize: 13 }}>
          ...
          {product.fastDelivery && (
            <span style={{ color: "#1d4ed8", fontWeight: 700 }}>🚚 Livraison rapide</span>
          )}
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: isAdded ? "#16a34a" : "linear-gradient(135deg, #1d4ed8, #1e3a8a)",
